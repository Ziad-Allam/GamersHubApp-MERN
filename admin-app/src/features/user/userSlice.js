...
export const getUsers = createAsyncThunk('/auth/getUsers',
    async () => {
        const response = await axios.get(`${base_url}admin/auth/get/users`, {
...
export const getAdmins = createAsyncThunk('/auth/getAdmins',
    async () => {
        const response = await axios.get(`${base_url}admin/auth/get/admins`, {
            withCredentials: true,
        });
        return response.data
    }
...
export const deleteUser = createAsyncThunk('/auth/deleteUser',
    async (id) => {
        const response = await axios.delete(`${base_url}admin/auth/delete/${id}`);
        return response.data
    }
)
