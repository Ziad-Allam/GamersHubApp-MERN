...
export const loginAdmin = createAsyncThunk('/auth/login-admin',
    async (formData) => {
        const response = await axios.post(`${base_url}admin/auth/login-admin`, formData, {
...
export const logoutAdmin = createAsyncThunk('/auth/logout-admin',
    async () => {
        const response = await axios.post(`${base_url}admin/auth/logout-admin`,{}, {
            withCredentials: true
        })
        return response.data
    }
...
export const checkAuth = createAsyncThunk('/auth/checkauth-admin',
    async () => {
        const response = await axios.get(`${base_url}admin/auth/check-auth-admin`, {
            withCredentials: true,
            headers: {
